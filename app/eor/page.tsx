        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8 pt-24 pb-20">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-wrap gap-3">
              <a href="#estimator" className="inline-flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-500 text-white font-bold px-7 py-4 rounded-xl transition-colors text-sm w-64">
                Open cost estimator <ArrowRight size={15} />
              </a>
              <a href="#countries" className="inline-flex items-center justify-center gap-2 bg-white/10 hover:bg-white/15 border border-white/20 text-white font-semibold px-7 py-4 rounded-xl transition-colors text-sm w-64">
                Browse countries
              </a>
            </div>
          </div>
      ...
      <section className="relative overflow-hidden" style={{backgroundColor: '#0d1f3c'}}>
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8 py-24 text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Link href="/countries/" className="inline-flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-500 text-white font-bold px-7 py-4 rounded-xl transition-colors w-64">Browse all countries <ArrowRight size={15} /></Link>
            <Link href="/payroll-tools/" className="inline-flex items-center justify-center gap-2 bg-white/10 hover:bg-white/15 border border-white/20 text-white font-semibold px-7 py-4 rounded-xl transition-colors w-64">Payroll calculators</Link>
          </div>
        </div>
      </section>

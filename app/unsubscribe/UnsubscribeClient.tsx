  ...
  return (
    <div className="w-full max-w-md">
      ...
      <div className="flex items-center gap-2.5 mb-10 justify-center">
        ...
        <span className="text-base font-bold text-white tracking-tight">BirrBank</span>
      </div>
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-8 text-center">
          ...
          <>
            ...
            {email ? (
              <p className="text-slate-400 text-sm leading-relaxed mb-8">
                You are about to unsubscribe <span className="text-white font-medium">{email}</span> from BirrBank monthly updates.
              </p>
            ) : (
              <p className="text-slate-400 text-sm leading-relaxed mb-8">
        ...
        {status === 'success' && (
          <>
            ...
            <p className="text-slate-400 text-sm leading-relaxed mb-8">
              <span className="text-white font-medium">{email}</span> has been removed from all BirrBank email updates. You will not receive any further emails from us.
            </p>
            <Link href="/"
        ...
        {status === 'already' && (
          <>
            ...
            <p className="text-slate-400 text-sm leading-relaxed mb-8">
              <span className="text-white font-medium">{email}</span> is not currently subscribed to BirrBank updates.
            </p>
            <Link href="/"
              className="inline-flex items-center gap-2 text-blue-400 hover:text-blue-300 text-sm font-medium transition-colors">
              Return to BirrBank
      ...
      <p className="text-slate-400 text-xs text-center mt-6">
        BirrBank.com · Global HR, EOR and Payroll Intelligence
      </p>
    </div>
  )
}

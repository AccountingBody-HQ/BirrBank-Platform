...
export default function AdminRateUpdaterPage() {
  return (
    <div style={{ padding: '32px', minHeight: '100vh', background: '#080d1a' }}>
      ...
      <div className="mb-8">
        ...
        <h1 className="font-bold text-white mb-2" style={{ fontSize: '28px', letterSpacing: '-0.5px' }}>Rate Updater</h1>
        <p style={{ color: '#475569', fontSize: '14px', maxWidth: '520px' }}>Update savings, loan and FX rates across all banks. Wire to Supabase savings_rates, loan_rates and exchange_rates tables in Phase 2.</p>
      </div>

            ...
            <div className="flex flex-wrap gap-3">
              {TOPICS.map(t => (
                <Link key={t.slug} href={`/hr-compliance/${t.slug}/`}
                  className="flex items-center justify-center gap-2 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-blue-400/50 rounded-xl px-4 py-2.5 transition-all group w-[160px]">

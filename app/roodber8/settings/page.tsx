  ...
  return (
    <div style={{ padding: '32px', minHeight: '100vh', background: '#080d1a' }}>
      ...
      <div className="mb-8">
        ...
        <h1 className="font-bold text-white mb-2" style={{ fontSize: '28px', letterSpacing: '-0.5px' }}>Settings</h1>
        <p style={{ color: '#475569', fontSize: '14px', maxWidth: '520px' }}>Platform configuration, environment variables and API key management.</p>
      </div>
